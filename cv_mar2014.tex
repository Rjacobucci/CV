...
\begin{itemize}
\item
	\ressubheading{University of Southern California (USC)}  {Los Angeles, California}{Ph.D. Psychology} {Expected 2017}
	\begin{itemize}
...
%
\item[]Skaar, N. R., Christ, T. J., \& \textbf{Jacobucci, R.} (In Press). \emph{Measuring Adolescent Prosocial and Health Risk Behavior in Schools: Initial Development of a Screening Measure.} School Mental Health.
%
%\item[]{\textbf{\large{Manuscripts in Preparation}}}
%
%\item[]McArdle, J. J, \& \textbf{Jacobucci, R.} (In Preparation). \emph{Confirmatory Testing of the Factors of Cognition as Measured in Project TALENT.} Multivariate Behavior Research.
%
...
\setlength{\leftmargin}{0.1in}
%
%\item[]{\textbf{\large{Individual Experience}}}
%
\item \textbf{Psychometric Expert} {Summer 2013-Present}
...
%
%%%%%%%%% Long Version %%%%%%%%%%%%%%%%
%\item \textbf{Teaching Assistant} {Spring 2013, History \& Systems}\\
%Supervisor: Dr. Andrew R. Gilpin, UNI\\
%Responsibilities include grading coursework, holding student lab meetings, and aiding students %throughout the course.
%
%\item \textbf{Teaching Assistant} {Spring 2013, Psychology of Music}\\
%Supervisor: Dr. Carolyn Hildebrandt, UNI\\
%Responsibilities include grading coursework, holding office hours, and aiding students %throughout the course.
%
%\item \textbf{Teaching Assistant} {Fall 2012, Advanced Graduate Statistics}\\
%Supervisor: Dr. Andrew R. Gilpin, UNI\\
%Responsibilities include grading coursework, holding student lab meetings, and aiding students %throughout the course.
%
%\item \textbf{Teaching Assistant} {Fall 2012, Cognitive \& Intellectual Assessment}\\
%Supervisor: Dr. John E. Williams, UNI\\
%Responsibilities include holding student lab meetings, creating test questions, grading %coursework, scheduling student assessments, and aiding students throughout the course.
%
%\item \textbf{Teaching Assistant} {Fall 2012, Honor's Introduction to Psychology}\\
%Supervisor: Dr. John E. Williams, UNI\\
%Responsibilities include assisting students with questions about the material and grading exams.
%
%\item \textbf{Teaching Assistant} {Spring 2012, Introduction to Psych Statistics}\\
%Supervisor: Dr. Andrew R. Gilpin, UNI\\
%Responsibilities included attending lectures, grading coursework, conducting study 	sessions, %and aiding students throughout the course.
%
%\item \textbf{Teaching Assistant} {Fall 2011, Memory \& Language}\\
%Supervisor: Dr. Jack Yates, UNI\\
%Responsibilities included attending lectures, grading coursework, conducting study 	sessions, %and aiding students throughout the course.
%
\item \textbf{Guest Lecturer} \\
Advanced Graduate Statistics (graduate: Dr. Andrew R. Gilpin), factor analysis.\\
Cognitive \& Intellectual Assessment (graduate: Dr. John E. Williams), theories of intelligence and test bias.\\
Honor's Introducton to Psychology (undergraduate: Dr. John E. Williams), intelligence.\\
%
\end{itemize}
...
%\item{\large{APA Division 5. Evaluation, Measurement, Stats}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\resheading{Web Based Programming}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{itemize} 
%\setlength{\topsep}{0pt}%
%\setlength{\leftmargin}{0.1in}%

%\item \textbf{Midwestern Q-Sort Program} {Summer 2012-Fall 2013}\\
%Update and redesign the program for the annual MMPI interpretation competition. Used HTML5, %Javascript, and CSS3 to design an interactive and scorable program to use as training for %graduate level clinical psychology students. 
%
%\item \textbf{UNI Assessment Clinic} {Summer 2012}\\
%Updated the style, content, and design of the website. Used HTML5 and CSS3 to make 	the %website easier to navigate and understand while enhancing stylistic components.\\
%
%\end{itemize}
...
R, SPSS, Amos, Mplus, S+, Winsteps, flexMIRT, SAS
%
\item \textbf{Programming and Markup Languages}\\
\LaTeX, Javascript, HTML5, CSS3, PHP 5
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{center} 
 \begin{center}
  \parbox{6.5in}{\textbf{Andrew Gilpin}, Ph.D., University of Northern Iowa}
  \parbox{6.5in}{Professor of Psychology}
  \parbox{6.5in}{andy.gilpin@uni.edu}
  \parbox{6.5in}{Phone: (319) 273-6104}
  \end{center}
\begin{center}
