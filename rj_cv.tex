...
\begin{itemize} 
	...
	%
	\item[] \textbf{Jacobucci, R.} (2023, June). Predicting suicidal ideation endorsement with text passively collected from screenshots. Paper submitted for presentation at the Society for Ambulatory Assessment Conference 2023, Amsterdam, Netherlands.
	%
