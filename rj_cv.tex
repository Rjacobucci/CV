...
\begin{etaremune}
		...
		\item  \textbf{Jacobucci, R.} \& Ammerman, B. (in press). Examining the dynamic relationship between nonsuicidal self-injury and alcohol use experiences. \emph{Suicide and Life-Threatening Behaviors}.
