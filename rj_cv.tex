...
\begin{etaremune}
		...
		\item Blacutt, M., O'Brien, C. M., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (in press). Balancing burden and resolution: Effects of EMA survey schedule on compliance and study evaluation in suicide-focused research. Journal of Psychiatric Research
	
	\item Blacutt, M., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (In press). The dynamic relationship between alcohol and suicidal ideation: Between-person associations and overnight inertia. Journal of Affective Disorders.
	...
	\item Shao, S., Xu, Z., Qu, W., \& \textbf{Jacobucci, R.} (2025). Sample Size Planning and Power Analysis for Detecting Cross-lagged Effects in Longitudinal Studies with Ordinal Outcomes. \emph{Fudan Journal of the Humanities and Social Sciences, 18}(4), 749-774.
