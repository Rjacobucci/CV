...
%
\item[] $+$Ober, T., Cheng, Y., \textbf{Jacobucci, R.,}, \& Whitney, B, M. (in press). Examining the within-domain factor structure of the big five inventory-2 with an adolescent sample. \emph{Psychological Assessment}. 
%
