...
\begin{etaremune}
	...
	\item Abber, S. R., Billman Miller, M. G., Hamilton, A., Ortiz, S. N., \textbf{Jacobucci, R. C.}, Essayli, J. H., Joiner, T. E., Smith, A. R., \& Forrest, L. N.  (in press). Bulimia nervosa severity levels based on shape/weight overvaluation explain more variance in clinical characteristics than DSM-5 severity levels. \emph{Psychological Medicine.}
	
	\item Ammerman, B. A., McClure, K., Law, K. C., O’Loughlin, C. M., \& \textbf{Jacobucci, R.} (in press). Online disclosure of suicide method: What can online posts tell us about suicidal planning?. \emph{Journal of Psychiatric Research.}
	
	\item Ammerman, B. A., O'Brien, C., Park, Y., \& \textbf{Jacobucci, R.} (in press). Momentary associations between positive coping and nonsuicidal self-injury risk among individuals with problematic alcohol use. \emph{Crisis: The Journal of Crisis Intervention and Suicide Prevention.}
	
	
		\item Billman Miller, M., Abber, S., Hamilton, A., Ortiz, S., \textbf{Jacobucci, R.}, Essayli, J., Smith, A., \& Forrest, L. (in press). Data mining identifies meaningful severity specifiers for anorexia nervosa. \emph{Journal of Psychopathology and Clinical Science.} 
	
		\item Ammerman, B., \&  \textbf{Jacobucci, R.} (in press). Proximal risk pathways of momentary alcohol urges and use: differences based on suicidal ideation history. \emph{Current Psychology}.
	
		\item Muehlenkamp, J. J., \textbf{Jacobucci, R.}, \& Ammerman, B. (in press). Body appreciation protects against proximal self-harm urges in a clinical sample of adults. \emph{Journal of Psychopathology and Behavioral Assessment}.
	
	\item \textbf{Jacobucci, R.}, Ammerman, B., \& $@$McClure, K. (in press). Understanding momentary missingness during ecological momentary assessment in clinical research: Implications for suicide research. \emph{Journal of Clinical Psychology}.
	
	
		\item $@$McClure, K., Ammerman, B., \&  \textbf{Jacobucci, R.} (in press). Are Items More Than Indicators? An examination of psychometric homogeneity, item-specific effects, and consequences for structural equation models. \emph{Multivariate Behavioral Research}.
	
		\item $@$Wilcox, K. T., \textbf{Jacobucci, R.}, $@_1$Waite, E., Dixon-Gordon, K., L., McCloskey, M.S., \& Ammerman, B.
	A. (in press). A Text Mining Approach to Characterizing Interpersonal Stress among Individuals with a Nonsuicidal Self-Injury History. \emph{Current Psychology}.
	
		\item $@$McClure, K., $@_1$Bell, K., \textbf{Jacobucci, R.}, \& Ammerman, B.A. (in press). Measurement invariance
	and response consistency of single-item assessments of suicidal thoughts and behaviors. \emph{Psychological Assessment.}
	
	\item Ammerman, B. \& \textbf{Jacobucci, R.} (in press). The impact of social connection on near-term suicidal ideation. \emph{Psychiatry Research}.
	%
