...
%
\item[]Ammerman, B. A., \textbf{Jacobucci, R.,}, Kleiman, E. M., Muehlenkamp, J. J., \& McCloskey, M. S. (In Press). \emph{Development and validation of empirically derived frequency criteria for NSSI disorder using exploratory data mining}, Psychological Assessment.
%
...
%
\item[]\textbf{Jacobucci, R.,} \& McArdle, J. J. (2015). Abstract: \emph{Regularized structural equation modeling, 50}(6), 736-736, 
Multivariate Behavioral Research. doi:10.1080/00273171.2015.1121125. 
%
...
%
\item[]Ammerman, B. A., \textbf{Jacobucci, R.}, Kleiman, E. M., Uyeji, L., \& McCloskey, M. S. (Under Review). \emph{The impact of NSSI age of onset on severity and suicidality.} Suicide and Life Threatening Behavior.
%
...
%
\item[]\textbf{Jacobucci, R.} (2016). regsem: Performs Regularization on Structural Equation Models (version 0.1.0) [Software]. Available from https://cran.r-project.org/web/packages/index.html
%
\item[]{\textbf{\large{In Development}}}
%
\item[]\textbf{Jacobucci, R.} (2016). autosem: Performs Specification Search in Structural Equation Models (version 0.0.900) [Software]. Available from https://github.com/Rjacobucci/autoSEM
%
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
