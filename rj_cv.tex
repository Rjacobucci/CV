...
% 
\item[] \textbf{Jacobucci, R.}, Brandmaier, A., \& Kievit, R. (accepted). A practicale guide to variable selection in structural equation models with regularized MIMIC models. \emph{Advances in Methods and Practices in Psychological Science.} 
%
\item[] Burke, T.A., Ammerman, B.A., \& \textbf{Jacobucci, R.} (in press). The use of machine learning in the study of suicidal and non-suicidal self-injurious thoughts and behavior: \emph{A systematic review. Journal of Affective Disorders.}
% 
