...
\begin{etaremune}
	%
	\item Ammerman, B.A., Burke, T.A., \textbf{Jacobucci, R.}., \& $@$McClure, K. (in press). Preliminary investigation of the association between COVID-19 and suicidal thoughts and behaviors in the U.S. \emph{Journal of Psychiatric Research}.
	%
...
\begin{itemize} 
	...
	\item[]\textbf{Jacobucci, R.} (Re-Scheduled for October 2020). \emph{Using imperfectly measured predictors in machine learning.} Workforce Science workshop at Rice University in Houston, Texas.
	%
