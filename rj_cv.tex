...
\begin{itemize} 
	...
	\item[]\textbf{Jacobucci, R.} \& Grimm, K. J. (under contract). \emph{Data mining in the social sciences.} New York, NY: Guilford.
\end{itemize}
...
\begin{itemize}
	...
	%
	\item[]\textbf{Jacobucci, R.} (2017). regsem: Performs Regularization on Structural Equation Models (version 0.7.0) [Software]. Available from https://cran.r-project.org/web/packages/index.html
	%
