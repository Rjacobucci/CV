...
\begin{etaremune}
	% 
	\item Rodgers, D. M., \textbf{Jacobucci, R.,} \& Grimm, K. J. (in press). A multiple imputation approach for handling missing data in classification and regression trees. \emph{Journal of Behavioral Data Science}.
	%
