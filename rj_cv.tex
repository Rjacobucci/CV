...
\begin{center}
	...
	\parbox{6.5in}{\textbf{NIH R03 MH120488-01} }
...
\begin{center}
	\parbox{6.5in}{{Evan Kleiman (PI)}    \hspace{9cm} 6/26/18-12/26/19}
...
\end{center}
	...
	%
		...
		\begin{center}
			...
			\parbox{6.5in}{\textbf{NIH RFA-MH-18-400 -- Addressing Suicide Research Gaps: Aggregating and Mining Existing Data Sets for Secondary Analyses} }
