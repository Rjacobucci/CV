...
%	\begin{center}
%		\parbox{6.5in}{{Evan Kleiman (PI)}   \flushright{Under Review}}
%		\parbox{6.5in}{\textbf{Sponsored: Military Suicide Research Consortium Common Data Elements} }
...
%	\begin{center}
%		\parbox{6.5in}{{Taylor Burke (PI)}   \flushright{10/16/17-10/16/18}}
%		\parbox{6.5in}{\textbf{Sponsored:  James Morgan Fund for New Directions in the Analysis of Complex %Interactions.} }
...
%
\item[]Stegmann, G., \textbf{Jacobucci, R.}, Harring, J., \& Grimm, K. J. (in press). Nonlinear mixed-effects modeling programs in R. \emph{Structural Equation Modeling}.
%
...
\item[] \textbf{Jacobucci, R.} \& Grimm, K. J. (accepted). Regularized estimation of multivariate latent change score models. Advances in Longitudinal Models for Multivariate Psychology: A Festschrift for Jack McArdle.
%
\item[] Grimm, K. J. \& \textbf{Jacobucci, R.} (accepted). Individually varying time metrics in latent change score models. Advances in Longitudinal Models for Multivariate Psychology: A Festschrift for Jack McArdle.
%
%
\vspace{3mm}
%
...
%
\item[] \textbf{Jacobucci, R.}, Grimm, K. J. (in revision). Comparison of frequentist and Bayesian regularization in structural equation modeling. %\emph{Structural Equation Modeling}.
%
\item[]Burke, T. A., \textbf{Jacobucci, R.}, Ammerman, B. A.,, Piccirillo, M., McCloskey M., \& Alloy, L. B. (in revision). Identifying the relative importance of non-suicidal self-injury features in predicting suicidal ideation and behavior using exploratory data mining. %\emph{Psychiatry Research}.
%
\item[]Ammerman, B. A., Serang, S., \textbf{Jacobucci}, R., Burke, T., A., Alloy, L. B., \& McCloskey, M. S. (under review). Exploratory Analysis of Mediators in the Relationship between Childhood Maltreatment and Suicidal Behavior. 
%
\item[]Serang, S. \& \textbf{Jacobucci, R.} (under review). Exploratory mediation analysis of dichotomous outcomes via regularization. %\emph{Psychological Methods}.
%
\item[]Stegmann, G., \textbf{Jacobucci, R.}, Serang, S., \& Grimm, K. J. (under review). Recursive partitioning with nonlinear change trajectories. %\emph{Psychological Methods}.
%
\item[]\textbf{Jacobucci, R.} (under review). regsem: Regularized structural equation modeling.
%
%
...
%
%\item[]Ammerman, B.A., \textbf{Jacobucci}, R., Turner, B. J., Serang, S., \& McCloskey, M.S. (In Preparation).  Quantifying the importance of lifetime frequency versus number of methods used in the consideration of NSSI severity.  

%\item[]Ammerman, B.A., \textbf{Jacobucci}, R., \& McCloskey, M.S. (In Preparation). Re-considering the importance of outcomes?: Further exploration of the NSSI Disorder Frequency Criteria. 
%
...
%
%\item[]McArdle, J. J, Bohrnstedt, G. A., Prescott, C. A., \textbf{Jacobucci, R.,} Grimm, K. J., Rebok, G., Lyter, D. A., \& Lapham, S. (in preparation). A confirmatory examination of the factors of cognition as measured in Project TALENT.% Multivariate Behavior Research.
%
...
%
\item[]\textbf{Jacobucci, R.} (2017, June). \emph{Exploratory data mining for a single outcome in clinical research.} Paper accepted for presentation at the 51st Annual Convention for the Association for Behavioral and Cognitive Therapies, San Diego, California.
%
\item[]Ammerman, B. A., \textbf{Jacobucci, R.}, Turner, B. J., Serang, S., \& McCloskey, M. S. (2017, June). \emph{Quantifying the importance of lifetime frequency versus number of methods used in the consideration of NSSI severity.} Paper accepted for presentation at the 51st Annual Convention for the Association for Behavioral and Cognitive Therapies, San Diego, California.
%
\item[]\textbf{Jacobucci, R.}, Serang, S., \& Ammerman, B.A. (2017, June). \emph{Multivariate approaches to exploratory data mining with the application of exploratory mediation for self-injury.} Paper accepted for at the 51st Annual Convention for the Association for Behavioral and Cognitive Therapies, San Diego, California.
%
\item[]Burke, T. A., \textbf{Jacobucci, R.}, Ammerman, B.A., Hamilton, J. L., \& Alloy, L. B. (2017, June). \emph{Using exploratory data mining to compare importance of risk factors in predicting recent versus former history of non-suicidal self-injury.} Paper accepted for at the 51st Annual Convention for the Association for Behavioral and Cognitive Therapies, San Diego, California.
%
\item[] Kleiman, E.M., \textbf{Jacobucci, R.}, Ammerman, B.A., Turner, B.J., Beale, E.E., Fedeor, S., Huffman, J.C., \& Nock, M. K. (2017, June). \emph{What affect states are most strongly associated with suicidal ideation? A real-time monitoring, exploratory data mining study.} Paper accepted for at the 51st Annual Convention for the Association for Behavioral and Cognitive Therapies, San Diego, California.
%
...
\begin{itemize}
	...
	%
	\item[]\textbf{Jacobucci, R.} (2017). regsem: Performs Regularization on Structural Equation Models (version 0.8.1) [Software]. Available from https://cran.r-project.org/web/packages/index.html
	%
	...
	%
	\item[]\textbf{Jacobucci, R.} (2017). dtree: Decision Trees (version 0.2.3) [Software]. Available from https://cran.r-project.org/web/packages/dtree/index.html
	%
...
\begin{center}
	...
	\parbox{6.5in}{Fall 2017, University of Notre Dame}
\end{center}
