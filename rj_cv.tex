...
\begin{itemize} 
	...
	\begin{center}
		\parbox{6.5in}{\textbf{NIH R21 MH129688-01}  \hspace{8cm} 3/4/22-2/29/24}
...
\begin{center}
	\parbox{6.5in}{\textbf{ND Lucy Family Institute for Data \& Society}  \hspace{4cm} June 2022 - 2023}
...
\begin{etaremune}
	...
	\item \textbf{Jacobucci, R.} \& $@$Li, X. (in press). Does Minority Case Sampling Improve Performance with Imbalanced Outcomes in Psychological Research? \emph{Journal of Behavioral Data Science}.
