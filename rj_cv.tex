...
%
%\item[] \textbf{Jacobucci, R.,} Ammerman, B. A., \& $@$Li, X. (revision requested). Using ordinal regression for advancing the ideation-to-action framework in suicide-focused research. \emph{Suicide and Life Threatening Behavior}.
%
