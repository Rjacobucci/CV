...
\begin{itemize}
	%
	\item
	\ressubheading{Research Associate Professor}{2026 - Current} {Center for Healthy Minds, University of Wisconsin-Madison}  {Madison, Wisconsin}
	\vspace{.15cm}
	%
	%
		\item
	\ressubheading{Research Assistant Professor}{2024 - 2026} {Center for Healthy Minds, University of Wisconsin-Madison}  {Madison, Wisconsin}
	\vspace{.15cm}
	%
	\item
...
\begin{itemize} 
	...
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{NIH R01MH142532}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 09/2026-08/2031}
		\parbox{6.5in}{{Brooke Ammerman (PI)}; Role: Co-I}
		\parbox{6.5in}{\textit{The Role of Social Connection in Suicide Risk among First-Year College Students}}
		\parbox{6.5in}{Total Costs: \$3,680,572}
	\end{center}
	
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{NIH R03 Project supported by P50MH129708}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 09/2026-08/2027}
		\parbox{6.5in}{{Brooke Ammerman (MPI); Role: MPI}}
		\parbox{6.5in}{\textit{Discovery and Refinement of a Just-in-Time Support for Outpatient Suicide Care}}
		\parbox{6.5in}{Total Costs: \$74,779}
	\end{center}
	
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{ARPA-H-CXHUB-26-109-TA1-0062}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 04/2026-04/2028}
		\parbox{6.5in}{{Ross Jacobucci (PI)}}
		\parbox{6.5in}{\textit{Multimodal Digital Phenotyping for Objective Measurement of Rapid Clinical Change in Behavioral Health (EVIDENT)}}
		\parbox{6.5in}{Total Costs: \$6,647,077}
	\end{center}
	
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{NIH R01MH143695}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 06/2026-05/2031}
		\parbox{6.5in}{{Brooke Ammerman (PI)}; Role: Co-I}
		\parbox{6.5in}{\textit{A Mechanistic Analysis of the Transition from Nonsuicidal to Suicidal Self-Injury in Adolescents}}
		\parbox{6.5in}{Total Costs: \$3,983,637}
	\end{center}
	
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{NIH R01 MH139512}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 08/2025-07/2029}
		\parbox{6.5in}{{Simon Goldberg (PI)}; Role: Co-I }
		\parbox{6.5in}{\textit{Optimizing the integration between human and digital support in a meditation app for depression and anxiety}}
		\parbox{6.5in}{Total Costs: \$3,055,801}
	\end{center}
	
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{Templeton World Charity Foundation}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 09/2024-08/2027}
		\parbox{6.5in}{{Richard Davidson (PI)}; Role: Co-I }
		\parbox{6.5in}{\textit{Personalized interventions and the scaling of human flourishing}}
		\parbox{6.5in}{Total Costs: \$1,267,192}
	\end{center}
...
\begin{center}
	...
	\parbox{6.5in}{{Kristin Valentino (PI)}; Role: Co-I }
...
%	\end{center}
	...
	\begin{center}
		\noindent\parbox{0.7\textwidth}{\raggedright \textbf{DARPA STRENGTHEN}}\hfill%
		\parbox{0.2\textwidth}{\raggedright 10/1/23-3/31/26}
		\parbox{6.5in}{{Davidson (Co-PI) \& Tononi (Co-PI) }; Role: Co-I  }
		\parbox{6.5in}{\textit{Hybrid interventions to cultivate well-being: mental exercise, physical exercise and transcranial electrical stimulation with temporal interference}}
		\parbox{6.5in}{Total Costs: \$14,163,731.00}
	\end{center}
...
\begin{etaremune}
		...
		\item Shao, W., Ammerman, B. A., \& \textbf{Jacobucci, R.} (2026). Authorship-resolved detection of suicidal ideation in smartphone screenshots: Which expressions track momentary self-report and clinical events. In \emph{Proceedings of the 2026 IEEE International Conference on Data Mining Workshops (ICDMW)}, 2nd Workshop on Mental Health Disorder Detection on Social Media (MHSM 2026), Shenyang, China. IEEE.
	
	\item Beloborodova, P., Chernicoff, L. I., Velarde Arrisueño, L. B., Olvera Puentes, J. M., Dahl, C. J., \textbf{Jacobucci, R.}, Davidson, R. J., Marquez-Padilla, F., Goldberg, S. B., \& Hirshberg, M. J. (in press). From self-regulation to character: Digital well-being intervention effects on character strengths and subsequent distress. \emph{Journal of Positive Psychology.}
	
		\item Blacutt, M., O'Brien, C. M., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (in press). Balancing burden and resolution: Effects of EMA survey schedule on compliance and study evaluation in suicide-focused research. \emph{Journal of Psychiatric Research}
	
	\item Blacutt, M., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (2026). The dynamic relationship between alcohol and suicidal ideation: Between-person associations and overnight inertia. \emph{Journal of Affective Disorders.}
	
	\item \textbf{Jacobucci, R.}, Shao, W., Kobrinsky, V., \& Ammerman, B. (2026). Predicting momentary suicidal ideation from smartphone screenshots using vision-language models: Prospective machine learning study. \emph{JMIR Mental Health, 13}(1), e90581.
	
	\item Muehlenkamp, J. J., O'Brien, C. M., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (2026). Sleep problems alter proximal risk of negative self-perceptions on suicide risk. \emph{Suicide and Life-Threatening Behavior, 56}(2), e70092.
	...
	\item Xu, I., \textbf{Jacobucci, R.}, \& Ammerman, B. A. (2025). Before the attempt: How people think and plan in suicide crises. \emph{Journal of Affective Disorders}, 119650.
	...
	\item Shao, S., Xu, Z., Qu, W., \& Jacobucci, R. (2025). Sample Size Planning and Power Analysis for Detecting Cross-lagged Effects in Longitudinal Studies with Ordinal Outcomes. \emph{Fudan Journal of the Humanities and Social Sciences}, 749-774.
	...
	\item Ammerman, B. A., McClure, K., Law, K. C., O’Loughlin, C. M., \& \textbf{Jacobucci, R.} (2025). Online disclosure of suicide method: What can online posts tell us about suicidal planning?. \emph{Journal of Psychiatric Research, 181.} 503-508.
...
\end{itemize}
\begin{etaremune}
	\item Lucas, J. (2025). What is AI-induced psychosis. National Geographic. https://www.nationalgeographic.com/health/article/what-is-ai-induced-psychosis-
...
\begin{itemize} 
	...
	\item []\textbf{Jacobucci, R.} (2026, May). \emph{Bridging Time Scales: From Screenshots to Self-Reports}. Invited talk given at the Mobile Methods Minicon @OSU, Columbus, OH, United States.
	
	\item[]\textbf{Jacobucci, R.} (2026, March). \emph{From Pixels to Predictions: Methodological Challenges in Linking Passively Captured Smartphone Screenshots to Real-Time Suicide Risk.} Invited talk given at the Quantitative Methods Speaker Series in the Department of Psychology at the University of Southern California.
	%
	...
	\item[] \textbf{Jacobucci, R.} (2026, April). Examining a comparison group of individuals with suicidal ideation [Paper presentation]. In J. Richardson (Chair), The Black Box Project: Insights from smartphone data among veterans who died by suicide [Symposium]. 2026 Suicide Research Symposium, Virtual.
	
	\item[] \textbf{Jacobucci, R. }(2026). Fine-tuning large language models for personalized suicide risk prediction from passively collected smartphone text [Paper presentation]. In P. Bloom (Chair), Natural language processing approaches to identify suicide risk [Symposium]. 2026 Suicide Research Symposium, Virtual.
	%
