...
701-318-5783 & Skype: ross.jacobucci
...
\begin{itemize}
	\item
	\ressubheading{Assistant Professor of Psychology}{2017 - Current} {University of Notre Dame}  {South Bend, Indiana}
%
\item
...
%
\item[]Burke, T. A., \textbf{Jacobucci, R.}, Ammerman, B. A.,, Piccirillo, M., McCloskey M., \& Alloy, L. B. (under review). Identifying the relative importance of non-suicidal self-injury features in predicting suicidal ideation and behavior using exploratory data mining. \emph{Psychiatry Research}.
%
\item[]Ammerman, B. A., Serang, S., \textbf{Jacobucci}, R., Burke, T., A., Alloy, L. B., \& McCloskey, M. S. (In  Preparation). Exploratory Analysis of Mediators in the Relationship between Childhood Maltreatment and Suicidal Behavior. \emph{Journal of Abnormal Child Psychology}.

%
\item[] \textbf{Jacobucci, R.}, Grimm, K. J. (in preparation). Regularized estimation of multivariate latent change score models. Invited book chapter for Advances in Longitudinal Models for Multivariate Psychology: A Festschrift for Jack McArdle.
%
...
\begin{center}
	...
	\parbox{6.5in}{8/15/2016-8/19/2016, University of Michigan, Ann Arbor, MI.}
...
\begin{center}
	...
	\parbox{6.5in}{APA Advanced Training Institutes. 6/6/2016-6/10/2016, Arizona State University, Tempe, AZ}
	\parbox{6.5in}{Role: Lecturer and lab instructor.}
	\parbox{6.5in}{Lecture Topic: Multivariate Decision Tree Methods}
