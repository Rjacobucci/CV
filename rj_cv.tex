...
\begin{itemize}
\item
	\ressubheading{University of Southern California (USC)}  {Los Angeles, California}{Ph.D. Psychology} {Expected Summer 2017}
	\begin{itemize}
		\resitem{Area: Quantitative Methods}
		\resitem{Dissertation: On the Application of Decision Trees in both} 
		\item[]{Psychological and Gerontological Research.}
	\end{itemize}
\item
