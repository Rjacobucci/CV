...
%
\item[] $+$Ober, T., Cheng, Y., \textbf{Jacobucci, R.,}, \& Whitney, B, M. (revision under review). Examining the within-domain factor structure of the big five inventory-2 with an adolescent sample. \emph{Psychological Assessment}. 
%
\item[] $@$Nelson, N. A., \textbf{Jacobucci, R.,} Grimm, K. J., \& Zelinski, E. (in press). The Bi-directional relationship between physical health and memory. \emph{Psychology \& Aging}.
%
\item[] Littlefield, A. K., Cooke, J. T., Bagge, C., Glenn, C., Kleiman, E. M., \textbf{Jacobucci, R.}, Millner, A. J., \& Steinley, D. (in press). Machine Learning to Classify Suicidal Thoughts and Behaviors: Implementation within the Common Data Elements used by the Military Suicide Research Consortium. \emph{Clinical Psychological Science.}
%

\item[] Jiang, M., Ammerman, B.A., $@_1$Zeng, Q., \textbf{Jacobucci, R.}, \& $@_1$Brodersen, A. (in press). Phrase-level Pairwise Topic Modeling to Uncover Helpful Peer Responses to Online Suicidal Crises. \emph{Humanities \& Social Sciences Communications}.
%
\item[] Forrest, L., \textbf{Jacobucci, R.,} \& Grilo, C. M. (in press). Empirically-Determined severity levels for binge-eating disorder outperform existing severity classification schemes. \emph{Psychological Medicine}.
%
\item[] \textbf{Jacobucci, R.,} Littlefield, A., Millner, A. J., Kleiman, E. M., \& Steinley, D. (in press). Evidence of inflated prediction performance: A commentary on machine learning and suicide research. \emph{Clinical Psychological Science.}
%
\item[] \textbf{Jacobucci, R.,} Ammerman, B. A., \& $@$Wilcox, K. (in press). The application of machine learning for text-based responses to improve suicide risk prediction. \emph{Suicide and Life Threatening Behavior}.
%
\item[] \textbf{Jacobucci, R.,} Ammerman, B. A., \& $@$Li, X. (in press). Using ordinal regression for advancing the understanding of distinct suicide outcomes. \emph{Suicide and Life Threatening Behavior}.
% 
...
%
%\item[] \textbf{Jacobucci, R.}. (revision requested). Are decision trees reliable enough for psychological research? \emph{Multivariate Behavioral Research}.
%
%\item[] $@$Nelson, N. A., \textbf{Jacobucci, R.,} Grimm, K. J., \& Zelinski, E. (revision requested). The Bi-directional relationship between physical health and cognitive ability. \emph{Psychology \& Aging}.
%
%\item[] Grimm, K. J., \textbf{Jacobucci, R.,} Stegmann, G., \& Serang, S. (under review). Explorations of individual change processes and their determinants: A novel approach and remaining challenges. \emph{Multivariate Behavioral Research}.
%
%
%\item[] $+$Ober, T., Cheng, Y., \textbf{Jacobucci, R.,}, \& Whitney, B, M. (under review). Examining the within-domain factor structure of the big five inventory-2 with an adolescent sample. \emph{Psychological Assessment}. 
% 
%\item[] Jiang, M., Ammerman, B.A., $@_1$Zeng, Q., \textbf{Jacobucci, R.}, \& $@_1$Brodersen, A. (revision under review). Phrase-level Pairwise Topic Modeling to Uncover Helpful Peer Responses to Online Suicidal Crises. \emph{Palgraves communications}.
%
%\item[] \textbf{Jacobucci, R.,} Ammerman, B. A., \& $@$Wilcox, K. (revision requested). The application of machine learning for text-based responses to improve suicide risk prediction. \emph{Suicide and Life Threatening Behavior}.
%
%\item[] Hendriks, A. M., Luningham, J. M., $@_1$Hong, M., \textbf{Jacobucci, R.,} Lundstrom, S., Larsson, H., Lichtenstein, P., Bartels, M., Finenauer, C., Boomsma, D. I., \& Lubke, G. H. (under review). 
%
%\item[] Zheng, A., Briley, D. A., \textbf{Jacobucci, R.,} Engelhardt, L. E., Harden, K. P., Tucker-Drob, E. M. (under review). Incremental validity of character measures over the big five inventory in predicting academic achievement.
%
%\item[] $@$Li, X., \& \textbf{Jacobucci, R.} (under review). Regularized structural equation modeling with stability selection.
%
%\item[] \textbf{Jacobucci, R.,} Littlefield, A., Millner, A. J., Kleiman, E. M., \& Steinley, D. (under review). Pairing machine learning and clinical psychology: How you evaluate predictive performance matters. 
%
%\item[] Goldammer, P., Annen, H., Lienhard, C., Jonas, K., \& \textbf{Jacobucci, R.} (under review). Benefits of regularization and relative importance analyses when dealing with overfitting and collinearity in latent regression models: An illustration in the context of cadre assessment in the Swiss Armed Force. 
%
%
%
...
%
\item[]\textbf{Jacobucci, R.} (2020, October). \emph{Using imperfectly measured predictors in machine learning.} Talk to be presented at the Workforce Science workshop at Rice University in Houston, Texas.
%
...
\begin{center}
	...
	\parbox{6.5in}{Fall 2017 \& 2018, University of Notre Dame}
\end{center}
...
\begin{center}
	...
	\parbox{6.5in}{Spring 2018, 2019, \& 2020, University of Notre Dame}
\end{center}
...
Journal of Consulting and Clinical Psychology; Structural Equation Modeling; Advances in Methods and Practices in Psychological Science; Multivariate Behavioral Research; Journal of Mathematical Psychology; Psychological Methods; Behavior Research Methods; Psychometrika; BMJ Open\\
