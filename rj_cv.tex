...
\begin{itemize} 
	...
	\item[]\textbf{Jacobucci, R.,} Grimm, K. J., \& Zhang, Z. (expected 7/23). \emph{Machine learning for social and behavioral research.} New York, NY: Guilford.
\end{itemize}
...
\end{itemize}
\begin{etaremune}
	\item Brandmaier, A. M. \& \textbf{Jacobucci, R.} (in press). Machine-learning approaches to structural
